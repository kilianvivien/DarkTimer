        ...
        <div className="space-y-4 border-t border-dark-border pt-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-ui-gray leading-relaxed">
              The built-in development chart used for offline recipe lookups contains manufacturer starting-point times for box speed at 20&nbsp;°C, compiled from manufacturer datasheets. Times requested at other temperatures or pushed/pulled ratings are scaled with generic compensation factors and flagged as rough estimates — always verify against the current manufacturer datasheet for your batch.
            </p>
          </div>
        </div>
      </div> : null}
